// types.js =  utilizado para definir constantes que representam os tipos de ações disponíveis em seu aplicativo
...
export const REGISTER_CREATED_SUCCESS = 'REGISTER__CREATED_SUCCESS';
